...
<html><head><title>NanoDex - WhatsApp Auth</title>
...
<html><head><title>NanoDex - Connected!</title>
<style>
...
export async function run(args: string[]): Promise<void> {
  ...
  const authProc = spawn(process.platform === 'win32' ? 'npx.cmd' : 'npx', ['tsx', ...authArgs], {
    cwd: projectRoot,
