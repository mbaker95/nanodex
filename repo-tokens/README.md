...
```yaml
- uses: mbaker95/nanodex/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [NanoDex](https://github.com/mbaker95/nanodex) | ![tokens](https://raw.githubusercontent.com/mbaker95/nanodex/main/repo-tokens/badge.svg) |
