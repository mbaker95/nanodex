...
const chatJid = process.env.NANODEX_CHAT_JID!;
const groupFolder = process.env.NANODEX_GROUP_FOLDER!;
const isMain = process.env.NANODEX_IS_MAIN === '1';
